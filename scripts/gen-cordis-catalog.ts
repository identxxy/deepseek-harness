...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  consoleClient: 'client-side Human Terminal catalog and attachment service — packages/client/ui-console/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ConsoleAttachmentAccess: 'console.md',
  ConsoleAttachmentOpenResult: 'console.md',
  ConsoleAttachmentSnapshot: 'console.md',
  ConsoleAttachRequest: 'console.md',
  ConsoleCreateRequest: 'console.md',
  ConsoleId: 'console.md',
  ConsoleOutputObservation: 'console.md',
  ConsoleRemoteArchiveRequest: 'console.md',
  ConsoleRemoteAttachRequest: 'console.md',
  ConsoleRemoteAttachmentAccessRequest: 'console.md',
  ConsoleRemoteAttachmentOpenResult: 'console.md',
  ConsoleRemoteAttachmentSnapshot: 'console.md',
  ConsoleRemoteCreateRequest: 'console.md',
  ConsoleRemoteIdRequest: 'console.md',
  ConsoleRemoteObservation: 'console.md',
  ConsoleRemoteReadRequest: 'console.md',
  ConsoleRemoteRenameRequest: 'console.md',
  ConsoleRemoteResizeRequest: 'console.md',
  ConsoleRemoteResult: 'console.md',
  ConsoleRemoteSnapshot: 'console.md',
  ConsoleRemoteWriteRequest: 'console.md',
  ConsoleOutputRead: 'console.md',
  ConsoleSize: 'console.md',
  ConsoleSnapshot: 'console.md',
  ...
  DeviceAuthentication: 'credentials.md',
  DeviceAuthenticateOptions: 'credentials.md',
  DeviceAuthIssueResult: 'credentials.md',
  DeviceLoginResult: 'credentials.md',
  DeviceTokenRotationResult: 'credentials.md',
  DeviceId: 'credentials.md',
  DevicePrincipalId: 'credentials.md',
  DeviceSessionId: 'credentials.md',
  DeviceView: 'credentials.md',
  VerifiedDevicePrincipal: 'credentials.md',
