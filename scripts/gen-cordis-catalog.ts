...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ConsoleAccess: 'console.md',
  ConsoleOpenResult: 'console.md',
  ConsoleOutputObservation: 'console.md',
  ConsoleRemoteAccessRequest: 'console.md',
