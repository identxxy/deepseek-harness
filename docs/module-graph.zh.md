...
| [`client-ui-console`](../packages/client/ui-console) | `client` | — |
...
| [`device-auth`](../packages/identity/device-auth) | `identity` | [`brand`](../packages/util/brand) |
...
| [`host-device-auth-web`](../packages/host/device-auth-web) | `host` | [`host-webserver`](../packages/host/webserver), [`storage-domain`](../packages/storage/storage-domain) |
| [`device-auth-domain`](../packages/identity/device-auth-domain) | `identity` | [`device-auth`](../packages/identity/device-auth), [`storage-domain`](../packages/storage/storage-domain) |
...
| [`console`](../packages/console/console) | `console` | [`brand`](../packages/util/brand), [`workspace`](../packages/workspace/workspace) |
...
| [`console-remote`](../packages/console/console-remote) | `console` | [`console`](../packages/console/console), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
| [`console-tmux`](../packages/console/console-tmux) | `console` | [`console`](../packages/console/console), [`subprocess`](../packages/subprocess/subprocess), [`workspace`](../packages/workspace/workspace) |
