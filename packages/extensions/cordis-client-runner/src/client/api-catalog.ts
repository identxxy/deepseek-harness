...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  {
    key: 'layout',
    summary: 'The outward layout face (`ctx.layout`): the viewing transitions other plugins may trigger — and exactly what a test fake must supply.',
    description: 'The outward layout face (`ctx.layout`): the viewing transitions other plugins may trigger — and exactly what a test fake must supply. The attachActions wiring hook stays on the concrete class (root-entry assembly only).',
    methods: [
      {
