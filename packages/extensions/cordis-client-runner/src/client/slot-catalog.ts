...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-console ConsoleLifecycleCoordinator id \'console-lifecycle\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'keyed',
    scope: 'root',
    summary: 'Plugin-owned contextual browser, selected by ctx.layout.openSidebarPage().',
    doc: 'Plugin-owned contextual browser, selected by ctx.layout.openSidebarPage().',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Optional primary actions rendered directly below New Session.',
    doc: 'Optional primary actions rendered directly below New Session.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-console NewTerminalAction id \'new-terminal\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.workspaces.actor',
    kind: 'list',
    scope: 'root',
    summary: 'Product-actor rows placed beside Session rows in the Workspace browser.',
    doc: 'Product-actor rows placed beside Session rows in the Workspace browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'client-ui-console ConsoleRows id \'console-rows\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.actor\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.actor\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Human Terminal body rendered for each Console pane occurrence.',
    doc: 'Human Terminal body rendered for each Console pane occurrence.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-console TerminalPane',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Plugin-owned content in the native pane canvas, without Session ownership.',
    doc: 'Plugin-owned content in the native pane canvas, without Session ownership.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'keyed',
    scope: 'root',
    summary: 'Plugin-owned pane title and navigation beside layout-owned pane controls.',
    doc: 'Plugin-owned pane title and navigation beside layout-owned pane controls.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workspace.panel.header\', () => ctx.slots.register(\n      { name: \'workspace.panel.header\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
