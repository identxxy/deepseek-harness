 ...
 * The MOBILE_NAV_BREAKPOINT is consumed by AppFrame, which switches to a
 * single-pane Session-list/conversation navigation below it; the solver
 * itself stays breakpoint-free and serves only the desktop layout.
 */
...
/** Viewport width below which the shell uses single-pane mobile navigation. */
