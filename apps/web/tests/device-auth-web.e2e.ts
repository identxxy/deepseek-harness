...
const leaf = fileURLToPath(new URL('../../../packages/host/device-auth-web/tests/fixtures/browser', import.meta.url))
const expectedDir = fileURLToPath(new URL('./expected/device-auth-web', import.meta.url))
