/** Snapshot ANSI renderer adapted from the local kitty-remote-deck implementation. */
  ...
  function renderTerminalLink(url, style, label = url) {
    if (!/^(https?:|file:)\/\//i.test(url)) return renderStyledText(label, style);
    if (!label) {
      return "";
    }
